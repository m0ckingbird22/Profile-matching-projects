...
public class PerusahaanPanel extends JPanel {
    ...
    private JPanel buildToolbar() {
        ...
        JLabel lblTitle = new JLabel("Data Perusahaan");
    ...
    public void refreshData() {
        ...
        List<Perusahaan> daftar = dao.getAll();
        for (Perusahaan p : daftar) {
    ...
    private void onTambah() {
        Perusahaan hasil = PerusahaanFormDialog.tampilkan(this, "Tambah Perusahaan", null);
        if (hasil == null) return;
        if (dao.insert(hasil)) refreshData();
        else JOptionPane.showMessageDialog(this, "Gagal menambah perusahaan.", "Error", JOptionPane.ERROR_MESSAGE);
    }
    ...
    private void onEdit() {
        ...
        Perusahaan existing = dao.getById(id);
        if (existing == null) { refreshData(); return; }
        Perusahaan hasil = PerusahaanFormDialog.tampilkan(this, "Edit Perusahaan", existing);
        if (hasil == null) return;
        if (dao.update(hasil)) refreshData();
        else JOptionPane.showMessageDialog(this, "Gagal update perusahaan.", "Error", JOptionPane.ERROR_MESSAGE);
    }
    ...
    private void onHapus() {
        ...
        int confirm = JOptionPane.showConfirmDialog(
            this,
            "Hapus perusahaan \"" + nama + "\"?\nPerusahaan yang masih punya lowongan tidak bisa dihapus.",
            "Konfirmasi Hapus",
        ...
        if (dao.delete(id)) refreshData();
            ...
            this,
            "Gagal hapus perusahaan. Kemungkinan masih ada lowongan yang mereferensikan perusahaan ini.",
            "Error",
